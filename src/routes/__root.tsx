...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Detour. — Luxury Real Estate Cinematography" },
      {
        name: "description",
        content:
          "Detour is a luxury real estate cinematography studio crafting cinematic property films, editorial photography and drone work.",
      },
